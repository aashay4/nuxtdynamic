    ...
    <div class="w3-col l8 s12">
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-justify">
          ...
          <p>With Intel Core i-7 processor, Intel Iris Plus GPU, up to 16 GB of RAM, and up to 2 TB storage, Lenovo Yoga C940 has one of the most advanced features in this list. It weighs just a little more than the other competitors. Apart from that, it offers a beautiful 4K display screen but battery life may be an issue with as it is lesser than the other laptops.</p><hr>
