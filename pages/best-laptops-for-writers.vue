        ...
        <div class="w3-justify">
          ...
          <div class="">
            ...
            <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
              ...
              <ul>
                ...
                <li><b>CPU:</b> 1-GHz Intel Core i5-1035G1 |</li>
                <li><b>GPU:</b> Intel UHD Graphics |</li>
                <li><b>Display:</b> 13.4-inch display 1920 x 1200</li>
              </ul>
          ...
          <div class="">
            ...
            <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
              ...
              <ul>
                <li><b>RAM:</b> 4 GB |</li>
                <li><b>Storage:</b> 64 GB |</li>
                <li><b>CPU:</b> Intel Core m3-8100Y |</li>
                <li><b>GPU:</b> Intel UHD 615 |</li>
                <li><b>Display:</b> 14-inch display 1920 x 1080</li>
              </ul>
          ...
          <div class="">
            ...
            <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
              ...
              <ul>
                ...
                <li><b>CPU:</b> Intel Core i5-1030NG7 |</li>
                <li><b>GPU:</b> Intel Iris Plus |</li>
                <li><b>Display:</b> 13.3-inch display 2560 x 1600</li>
              </ul>
          ...
          <div class="">
            ...
            <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
              ...
              <ul>
                ...
                <li><b>CPU:</b> Intel 10th Quad Core i5-10210U |</li>
                <li><b>GPU:</b> Intel UHD Graphics 620 |</li>
          ...
          <h2>Google Pixelbook Go</h2>
            ...
            <div class="">
              ...
              <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
                ...
                <ul>
                  <li><b>RAM:</b> 8 GB |</li>
                  <li><b>Storage:</b> 128 TB |</li>
                  <li><b>CPU:</b> Intel Core i5-8200Y |</li>
                  <li><b>GPU:</b> Intel UHD 615 GPU |</li>
                  <li><b>Display:</b> 13.3-inch display 1920 x 1080</li>
                </ul>
            ...
            <div class="">
              ...
              <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
                ...
                <ul>
                  <li><b>RAM:</b> 8 GB |</li>
                  <li><b>Storage:</b> 256 GB |</li>
                  <li><b>CPU:</b> 8th-generation quad-core Core i5-8250 |</li>
                  <li><b>GPU:</b> Intel 620 UHD |</li>
                  <li><b>Display:</b> 13.3-inch full-HD </li>
                </ul>
            ...
            <div class="">
              ...
              <p class="w3-large"><b><i class="fa fa-list-alt w3-margin-right w3-text-teal"></i>Specifications</b></p>
                ...
                <ul>
                  <li><b>RAM:</b> 4 GB |</li>
                  <li><b>Storage:</b> 64 GB |</li>
                  <li><b>CPU:</b> Intel Pentium N4200 |</li>
                  <li><b>Display:</b> 12.2-inch 1920 x 1200 </li>
                </ul>
