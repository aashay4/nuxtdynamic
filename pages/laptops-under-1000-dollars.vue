    ...
    <div class="w3-col l8 s12">
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-justify">
          ...
          <p>Asus ZenBook 13 can run every task smoothly and can be considered as a multi-purpose laptop. With 13.3 inches screen and just 2.7 pounds weight, it is really easy to carry this laptop to a meeting or college presentation.</p>
          <h3>Acer Swift 3</h3>
